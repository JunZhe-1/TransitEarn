...
function PointTransfer() {
  ...
  // }
  // else if (user.id){
  //   console.log("code 40 in pointtransfer");
  //   return;
  // }
  ...
  // };
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '50% 50%', minHeight: '88vh', width: '132%', marginLeft: '-26.8   vh', backgroundColor: '#f0f0f0' }}>
      <div style={{ backgroundImage: `url(${imageUrl})`, backgroundSize: 'cover', backgroundPosition: 'left', height: '100%', width: '85%', borderRadius: '20px' }}></div>
      <div style={{ color: 'black', textAlign: 'center', maxWidth: '500px' }}>
